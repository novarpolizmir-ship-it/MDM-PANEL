...
document.localization ['en_US'] = {
    ...
    'devices.config.sync.ok': 'Configuration up-to-date - device received latest changes',
    'devices.config.sync.pending': 'Update pending - device has not yet received new configuration',
    'devices.config.sync.unknown': 'Status unknown',
    ...
    'table.heading.device.config.status': 'Update Status',
